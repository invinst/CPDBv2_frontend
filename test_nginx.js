...
describe('nginx config', () => {
  ...
  const testCases = [
    ...
    mobileNotRedirect('/documents/'),
    mobileNotRedirect('/edit/documents/'),
    mobileNotRedirect('/document/1234/'),
    mobileNotRedirect('/edit/document/1234/'),
    mobileNotRedirect('/crawlers/'),
    mobileNotRedirect('/documents/crid/123abc/'),
    mobileNotRedirect('/edit/documents/crid/123abc/'),
