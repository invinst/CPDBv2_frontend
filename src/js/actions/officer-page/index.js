...
export const turnOnTriangleExplainEditMode = createChangeEditModeAction(OFFICER_EDIT_MODE)(
  OFFICER_EDIT_TYPES.TRIANGLE, true
);
export const turnOffTriangleExplainEditMode = createChangeEditModeAction(OFFICER_EDIT_MODE)(
  OFFICER_EDIT_TYPES.TRIANGLE, false
);

export const turnOnScaleExplainEditMode = createChangeEditModeAction(OFFICER_EDIT_MODE)(
  OFFICER_EDIT_TYPES.SCALE, true
);
export const turnOffScaleExplainEditMode = createChangeEditModeAction(OFFICER_EDIT_MODE)(
  OFFICER_EDIT_TYPES.SCALE, false
);

export const turnOnNoDataRadarChartExplainEditMode = createChangeEditModeAction(OFFICER_EDIT_MODE)(
  OFFICER_EDIT_TYPES.NO_DATA_RADAR_CHART, true);
export const turnOffNoDataRadarChartExplainEditMode = createChangeEditModeAction(OFFICER_EDIT_MODE)(
