...
export const turnOnNoAttachmentTextEditMode = createChangeEditModeAction(CR_EDIT_MODE)(
  CR_EDIT_TYPES.NO_ATTACHMENT_TEXT, true
);
export const turnOffNoAttachmentTextEditMode = createChangeEditModeAction(CR_EDIT_MODE)(
  CR_EDIT_TYPES.NO_ATTACHMENT_TEXT, false
);

export const turnOnDocumentRequestInstructionEditMode = createChangeEditModeAction(CR_EDIT_MODE)(
  CR_EDIT_TYPES.DOCUMENT_REQUEST_INSTRUCTION, true
);
export const turnOffDocumentRequestInstructionEditMode = createChangeEditModeAction(CR_EDIT_MODE)(
  CR_EDIT_TYPES.DOCUMENT_REQUEST_INSTRUCTION, false
);

export const turnOnNewDocumentNotificationEditMode = createChangeEditModeAction(CR_EDIT_MODE)(
  CR_EDIT_TYPES.NEW_DOCUMENT_NOTIFICATIONS_INSTRUCTION, true
);
export const turnOffNewDocumentNotificationEditMode = createChangeEditModeAction(CR_EDIT_MODE)(
