...
import { plusPlaceholderHeight } from 'components/search-page/search-content.style';
import {
...
const occupiedHeight = (
  navWrapperCompactHeight + tagsWrapperHeight + plusPlaceholderHeight + loadMoreButtonHeight + headerHeight
);
